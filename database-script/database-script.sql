...
GO
/****** Object:  Table [dbo].[LinkForEachProductInStore]    Script Date: 25/07/2021 14:56:08 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[PricesForEachStore]    Script Date: 25/07/2021 14:56:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Products]    Script Date: 25/07/2021 14:56:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Stores]    Script Date: 25/07/2021 14:56:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[AddProduct]    Script Date: 25/07/2021 14:56:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Update the table
UPDATE LinkForEachProductInStore
SET Link = @UrlLink
WHERE ProductId = (SELECT Id FROM Products WHERE ProductNumber = @ProductNumber) AND StoreId = (SELECT Id FROM Stores WHERE StoreName = @ProductStore)

-- If there aren't any modification insert the data
if @@ROWCOUNT = 0
BEGIN
...
-- Update the table
UPDATE PricesForEachStore
SET IsAvailable = @IsProductAvailable, Price = @ProductPrice 
WHERE ProductId = (SELECT Id FROM Products WHERE ProductNumber = @ProductNumber) AND StoreId = (SELECT Id From Stores Where StoreName = @ProductStore)
