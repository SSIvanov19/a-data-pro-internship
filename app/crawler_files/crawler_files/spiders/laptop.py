...
class LaptopSpider(scrapy.Spider):
    ...
    def extractInfo(self, response):
        ...
        item = {
            "productName": response.xpath(
                """/html/body/div[1]/article/form[2]/div/header/h1/text()"""
            )
            .get()
            .replace("\n", "")
            .replace('"', ""),
            ...
            "productPrice": float(
                response.xpath(
                    """/html/body/div[1]/article/form[2]/div/section/div[1]/div[1]/div[1]/span[2]/span[1]/text()"""
                ).get()
            ),
        }
    ...
    def parse(self, response):
        ...
        self.href = response.xpath(
            """//*[@class="products"]/li/article/a/@href"""
        ).extract()
